...
<section class="section">
    <div class="container">
        ...
        <div class="blog-grid">
            @php $posts = [
                ['blog1.jpg','Web Design','May 5, 2026','10 Web Design Trends to Watch in 2026','Discover the latest design trends shaping the web in 2026, from glassmorphism to AI-generated layouts.'],
            ...
            <div class="blog-card">
                <div class="blog-img">
                    <img src="{{ asset('images/blog/'.$post[0]) }}" alt="{{ $post[3] }}" style="width:100%;height:100%;object-fit:cover;">
                </div>
                <div class="blog-body">
